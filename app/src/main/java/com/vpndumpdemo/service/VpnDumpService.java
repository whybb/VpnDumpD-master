package com.vpndumpdemo.service;
...
import com.vpndumpdemo.model.App;
import com.vpndumpdemo.net.ByteBufferPool;
import com.vpndumpdemo.net.NetInput;
//import com.vpndumpdemo.net.NetNotifyThread;
import com.vpndumpdemo.net.NetOutput;
import com.vpndumpdemo.net.Packet;
import com.vpndumpdemo.net.TCB;
import com.vpndumpdemo.net.TCBCachePool;
import com.vpndumpdemo.pcap.PCapFilter;
//import com.vpndumpdemo.utils.AppUtils;
import com.vpndumpdemo.utils.AppUtils;
...
/**
 * Vpnservice 核心类--只有开启此类才能进行抓包的操作---利用VPN的代理机制进行抓包
 */
public class VpnDumpService extends VpnService implements Runnable {
