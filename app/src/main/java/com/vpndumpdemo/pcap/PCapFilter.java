...
import  com.vpndumpdemo.model.PcapFile;
import  com.vpndumpdemo.service.VpnDumpService;
import  com.vpndumpdemo.utils.SDCardUtils;
...
//        mCapAppId = -1;
         String dirName =  SDCardUtils.getSDCardPath()+"NetDump/";
        //String dirName= Environment.getExternalStorageDirectory()+"/NetDump";
